 ...
 * @author Fikri Ilyas
 */
public class BinHeaderTrailProtocolCodecFactory implements ProtocolCodecFactory {

    public BinHeaderTrailProtocolCodecFactory() {
    }
    ...
    public ProtocolDecoder getDecoder(IoSession is) throws Exception {
        return new BinHeaderTrailDecoder();
    }
}